# Function to validate OneDrive installation via registry
# function Validate-OneDriveInstallation {
#     param (
#         [string]$ODRegKey
#     )
    
#     if (-not (Test-Path $ODRegKey)) {
#         Write-Log "Registry path not found: $ODRegKey" -Level "ERROR"
#         return @{ IsInstalled = $false }
#     }
    
#     try {
#         $installedVersion = Get-ItemPropertyValue -Path $ODRegKey -Name Version
#         Write-Log "Found installed OneDrive version: $installedVersion" -Level "INFO"
#         return @{
#             IsInstalled = $true
#             Version     = [System.Version]::new($installedVersion)
#         }
#     }
#     catch {
#         Write-Log "An error occurred while retrieving OneDrive version: $($_.Exception.Message)" -Level "ERROR"
#         return @{ IsInstalled = $false }
#     }
# }
